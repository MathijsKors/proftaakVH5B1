...
@Controller
public class FysioAPIController {

    private final Logger logger = LoggerFactory.getLogger(FysioAPIController.class);

    // Lees een property uit resources/application.properties
    @Value("${http://fysioivh5b2.herokuapp.com/api/appointmentstopay}")
